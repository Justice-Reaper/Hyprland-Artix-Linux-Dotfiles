...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("setpriv --ambient-caps -all wl-clip-persist --clipboard both --reconnect-tries inf -e")
...
hl.config({
    render = {
        -- Expands edge pixels instead of stretching the whole texture when a window hasn't redrawn yet during resize
...
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("/home/justice-reaper/.config/rofi/manager/manager.sh"))
...
hl.bind(mainMod .. " + SHIFT + M", hl.dsp.exec_cmd("hyprland-minimizer"))
